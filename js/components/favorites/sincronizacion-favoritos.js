...
import { AUTH_STATES, waitForSession, subscribeSession } from '../../core/auth/coordinador-sesion.js?v=tintin-20260924-auth-state-authority-1-auth-popup-resolver-1';
...
document.addEventListener('click', async event => {
  ...
  if (!item) return;
  const cart = await import('../cart/sincronizacion-carrito.js?v=tintin-20260918-global-session-restore-1-auth-persistence-20260919-1-auth-popup-resolver-1');
