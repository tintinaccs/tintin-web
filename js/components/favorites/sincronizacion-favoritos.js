...
import { AUTH_STATES, waitForSession, subscribeSession } from '../../core/auth/coordinador-sesion.js?v=tintin-20260923-auth-cache-coherence-1';
...
document.addEventListener('click', async event => {
  ...
  if (!item) return;
  const cart = await import('../cart/sincronizacion-carrito.js?v=tintin-20260923-auth-cache-coherence-1');
