...
import { validateImageFile } from './procesamiento-imagenes.js?v=tintin-20260820-microcopy-ios-1';
import {
  deleteMediaByUrlIfUnused,
  deleteMediaItem,
  uploadImageToLibrary
} from './biblioteca-multimedia.js?v=tintin-20260820-microcopy-ios-1';
