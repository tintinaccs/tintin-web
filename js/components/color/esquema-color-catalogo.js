 ...
 * aplicación (js/components/color/esquema-color.js y js/admin/settings/esquema-color-admin.js), así los tres
...
export const GLOBAL_TOKENS = [
  // Generales / marca
  { key: 'brand-primary', cssVar: '--color-brand-primary', label: 'Color principal de marca', category: 'generales', default: '#EA7EA3' },
  { key: 'brand-secondary', cssVar: '--color-brand-secondary', label: 'Color secundario de marca', category: 'generales', default: '#F6BFD3' },
  { key: 'brand-accent', cssVar: '--color-brand-accent', label: 'Color de acento suave', category: 'generales', default: '#FDF0F5' },
  { key: 'brand-primary-hover', cssVar: '--color-brand-primary-hover', label: 'Color principal — hover', category: 'generales', default: '#EA7EA3' },

  // Fondos
  { key: 'bg-page', cssVar: '--color-background-page', label: 'Fondo de página', category: 'fondos', default: '#FDF0F5' },
  { key: 'bg-surface', cssVar: '--color-background-surface', label: 'Fondo de tarjetas/superficie', category: 'fondos', default: '#FFFFFF' },
  { key: 'bg-surface-soft', cssVar: '--color-background-surface-soft', label: 'Fondo de sección suave', category: 'fondos', default: '#FFFFFF' },
  ...
  { key: 'bg-submenu', cssVar: '--color-background-submenu', label: 'Fondo de submenús', category: 'fondos', default: '#FFFFFF' },
  { key: 'bg-table', cssVar: '--color-background-table', label: 'Fondo de tablas', category: 'fondos', default: '#FFFFFF' },
  { key: 'bg-table-row-hover', cssVar: '--color-background-table-row-hover', label: 'Fondo de fila (hover)', category: 'fondos', default: '#FFFFFF' },
  { key: 'bg-field', cssVar: '--color-background-field', label: 'Fondo de campos de formulario', category: 'fondos', default: '#FFFFFF' },
  { key: 'bg-float', cssVar: '--color-background-float', label: 'Fondo de botones/componentes flotantes', category: 'fondos', default: '#EA7EA3' },
  ...
  { key: 'bg-selected', cssVar: '--color-background-selected', label: 'Fondo de elemento seleccionado', category: 'fondos', default: '#FDF0F5' },
  { key: 'bg-disabled', cssVar: '--color-background-disabled', label: 'Fondo de elemento deshabilitado', category: 'fondos', default: '#FADCE9' },

  // Tipografía
  { key: 'text-primary', cssVar: '--color-text-primary', label: 'Texto principal', category: 'tipografia', default: '#EA7EA3' },
  { key: 'text-secondary', cssVar: '--color-text-secondary', label: 'Texto secundario', category: 'tipografia', default: '#EA7EA3' },
  { key: 'text-tertiary', cssVar: '--color-text-tertiary', label: 'Texto terciario', category: 'tipografia', default: '#EA7EA3' },
  { key: 'text-muted', cssVar: '--color-text-muted', label: 'Texto tenue', category: 'tipografia', default: '#EA7EA3' },
  { key: 'text-disabled', cssVar: '--color-text-disabled', label: 'Texto deshabilitado', category: 'tipografia', default: '#EA7EA3' },
  ...
  { key: 'text-title', cssVar: '--color-text-title', label: 'Títulos', category: 'tipografia', default: '#EA7EA3' },
  { key: 'text-subtitle', cssVar: '--color-text-subtitle', label: 'Subtítulos', category: 'tipografia', default: '#EA7EA3' },
  { key: 'text-label', cssVar: '--color-text-label', label: 'Etiquetas de campo', category: 'tipografia', default: '#EA7EA3' },
  { key: 'text-placeholder', cssVar: '--color-text-placeholder', label: 'Placeholders', category: 'tipografia', default: '#EA7EA3' },
  { key: 'text-link', cssVar: '--color-text-link', label: 'Enlaces', category: 'tipografia', default: '#EA7EA3' },
  { key: 'text-link-visited', cssVar: '--color-text-link-visited', label: 'Enlaces visitados', category: 'tipografia', default: '#EA7EA3' },
  { key: 'text-help', cssVar: '--color-text-help', label: 'Textos de ayuda', category: 'tipografia', default: '#EA7EA3' },

  // Botones
  { key: 'btn-primary-bg', cssVar: '--color-button-primary-background', label: 'Botón principal — fondo', category: 'botones', default: '#EA7EA3' },
  { key: 'btn-primary-text', cssVar: '--color-button-primary-text', label: 'Botón principal — texto', category: 'botones', default: '#FFFFFF' },
  { key: 'btn-primary-border', cssVar: '--color-button-primary-border', label: 'Botón principal — borde', category: 'botones', default: '#EA7EA3' },
  { key: 'btn-primary-hover', cssVar: '--color-button-primary-hover', label: 'Botón principal — hover', category: 'botones', default: '#EA7EA3' },
  { key: 'btn-primary-active', cssVar: '--color-button-primary-active', label: 'Botón principal — active', category: 'botones', default: '#EA7EA3' },
  ...
  { key: 'btn-primary-disabled-bg', cssVar: '--color-button-primary-disabled-background', label: 'Botón principal — fondo disabled', category: 'botones', default: '#FADCE9' },
  { key: 'btn-primary-disabled-text', cssVar: '--color-button-primary-disabled-text', label: 'Botón principal — texto disabled', category: 'botones', default: '#EA7EA3' },
  ...
  { key: 'btn-secondary-text', cssVar: '--color-button-secondary-text', label: 'Botón secundario — texto', category: 'botones', default: '#EA7EA3' },
  { key: 'btn-secondary-border', cssVar: '--color-button-secondary-border', label: 'Botón secundario — borde', category: 'botones', default: '#EA7EA3' },
  { key: 'btn-secondary-hover', cssVar: '--color-button-secondary-hover', label: 'Botón secundario — hover', category: 'botones', default: '#FFFFFF' },
  { key: 'btn-secondary-active', cssVar: '--color-button-secondary-active', label: 'Botón secundario — active', category: 'botones', default: '#FDF0F5' },
  ...
  { key: 'btn-secondary-disabled-bg', cssVar: '--color-button-secondary-disabled-background', label: 'Botón secundario — fondo disabled', category: 'botones', default: '#FADCE9' },
  { key: 'btn-secondary-disabled-text', cssVar: '--color-button-secondary-disabled-text', label: 'Botón secundario — texto disabled', category: 'botones', default: '#EA7EA3' },
  ...
  { key: 'btn-warning-bg', cssVar: '--color-button-warning-background', label: 'Botón de advertencia — fondo', category: 'botones', default: '#FDF0F5' },
  ...
  { key: 'btn-neutral-bg', cssVar: '--color-button-neutral-background', label: 'Botón neutral — fondo', category: 'botones', default: '#FADCE9' },
  { key: 'btn-neutral-text', cssVar: '--color-button-neutral-text', label: 'Botón neutral — texto', category: 'botones', default: '#EA7EA3' },
  ...
  { key: 'btn-icon-text', cssVar: '--color-button-icon-text', label: 'Botones de íconos — color', category: 'botones', default: '#EA7EA3' },
  { key: 'btn-icon-disabled', cssVar: '--color-button-icon-disabled-text', label: 'Botones de íconos — deshabilitado', category: 'botones', default: '#EA7EA3' },
  { key: 'btn-floating-bg', cssVar: '--color-button-floating-background', label: 'Botones flotantes — fondo', category: 'botones', default: '#EA7EA3' },
  { key: 'btn-floating-text', cssVar: '--color-button-floating-text', label: 'Botones flotantes — texto', category: 'botones', default: '#FFFFFF' },
  { key: 'btn-sticky-bg', cssVar: '--color-button-sticky-background', label: 'Botones sticky — fondo', category: 'botones', default: '#EA7EA3' },
  ...
  { key: 'btn-outline-text', cssVar: '--color-button-outline-text', label: 'Botones outline — texto', category: 'botones', default: '#EA7EA3' },
  { key: 'btn-outline-border', cssVar: '--color-button-outline-border', label: 'Botones outline — borde', category: 'botones', default: '#EA7EA3' },
  { key: 'btn-transparent-text', cssVar: '--color-button-transparent-text', label: 'Botones transparentes — texto', category: 'botones', default: '#EA7EA3' },

  // Bordes y divisores
  { key: 'border-primary', cssVar: '--color-border-primary', label: 'Borde principal', category: 'bordes', default: '#FADCE9' },
  { key: 'border-secondary', cssVar: '--color-border-secondary', label: 'Borde secundario / divisores', category: 'bordes', default: '#FDF0F5' },
  { key: 'border-focus', cssVar: '--color-border-focus', label: 'Borde de focus', category: 'bordes', default: '#EA7EA3' },
  ...
  { key: 'state-warning-bg', cssVar: '--color-warning-background', label: 'Advertencia — fondo', category: 'estados', default: '#FDF0F5' },
  ...
  { key: 'state-neutral-bg', cssVar: '--color-neutral-background', label: 'Neutral — fondo', category: 'estados', default: '#FADCE9' },
  { key: 'state-neutral-text', cssVar: '--color-neutral-text', label: 'Neutral — texto', category: 'estados', default: '#EA7EA3' },
  ...
  { key: 'state-discount', cssVar: '--color-state-discount', label: 'Descuento', category: 'estados', default: '#EA7EA3' },
  { key: 'state-promo', cssVar: '--color-state-promo', label: 'Promoción', category: 'estados', default: '#EA7EA3' },
  { key: 'state-selected', cssVar: '--color-state-selected', label: 'Seleccionado', category: 'estados', default: '#EA7EA3' },
  { key: 'state-hover', cssVar: '--color-state-hover', label: 'Hover (genérico)', category: 'estados', default: '#FFFFFF' },
  { key: 'state-focus', cssVar: '--color-state-focus', label: 'Focus (genérico)', category: 'estados', default: 'rgba(173,63,103,0.24)' },
  { key: 'state-active', cssVar: '--color-state-active', label: 'Active (genérico)', category: 'estados', default: '#FDF0F5' },
  { key: 'state-disabled', cssVar: '--color-state-disabled', label: 'Disabled (genérico)', category: 'estados', default: '#EA7EA3' },

  // Formularios
  { key: 'field-bg', cssVar: '--color-field-background', label: 'Campos — fondo', category: 'formularios', default: '#FFFFFF' },
  { key: 'field-text', cssVar: '--color-field-text', label: 'Campos — texto', category: 'formularios', default: '#EA7EA3' },
  { key: 'field-border', cssVar: '--color-field-border', label: 'Campos — borde', category: 'formularios', default: '#FADCE9' },
  { key: 'field-border-focus', cssVar: '--color-field-border-focus', label: 'Campos — borde de focus', category: 'formularios', default: '#EA7EA3' },
  { key: 'field-placeholder', cssVar: '--color-field-placeholder', label: 'Campos — placeholder', category: 'formularios', default: '#EA7EA3' },

  // Navegación
  { key: 'nav-active-bg', cssVar: '--color-nav-active-background', label: 'Navegación activa — fondo', category: 'navegacion', default: '#FDF0F5' },
  { key: 'nav-active-text', cssVar: '--color-nav-active-text', label: 'Navegación activa — texto', category: 'navegacion', default: '#EA7EA3' },
  { key: 'nav-inactive-text', cssVar: '--color-nav-inactive-text', label: 'Navegación inactiva — texto', category: 'navegacion', default: '#EA7EA3' },
  { key: 'tab-active-bg', cssVar: '--color-tab-active-background', label: 'Pestaña activa — fondo', category: 'navegacion', default: '#EA7EA3' },
  { key: 'tab-active-text', cssVar: '--color-tab-active-text', label: 'Pestaña activa — texto', category: 'navegacion', default: '#FFFFFF' },
  { key: 'tab-inactive-text', cssVar: '--color-tab-inactive-text', label: 'Pestaña inactiva — texto', category: 'navegacion', default: '#EA7EA3' },
  { key: 'breadcrumb-text', cssVar: '--color-breadcrumb-text', label: 'Breadcrumbs', category: 'navegacion', default: '#EA7EA3' },
  { key: 'breadcrumb-active', cssVar: '--color-breadcrumb-active-text', label: 'Breadcrumb activo', category: 'navegacion', default: '#EA7EA3' },
  { key: 'accordion-header-bg', cssVar: '--color-accordion-header-background', label: 'Encabezado de acordeón', category: 'navegacion', default: '#FFFFFF' },
  { key: 'indicator', cssVar: '--color-indicator', label: 'Indicadores (puntos, pills)', category: 'navegacion', default: '#EA7EA3' },

  // Tarjetas y tablas
  { key: 'card-border', cssVar: '--color-card-border', label: 'Borde de tarjetas', category: 'tarjetas', default: '#FADCE9' },
  { key: 'card-shadow', cssVar: '--color-card-shadow', label: 'Sombra de tarjetas', category: 'tarjetas', default: 'rgba(212,106,138,0.10)' },
  { key: 'table-border', cssVar: '--color-table-border', label: 'Bordes de tabla', category: 'tarjetas', default: '#FADCE9' },
  { key: 'table-header-bg', cssVar: '--color-table-header-background', label: 'Encabezado de tabla — fondo', category: 'tarjetas', default: '#FDF0F5' },
  { key: 'table-header-text', cssVar: '--color-table-header-text', label: 'Encabezado de tabla — texto', category: 'tarjetas', default: '#EA7EA3' },
  { key: 'badge-bg', cssVar: '--color-badge-background', label: 'Badges — fondo', category: 'tarjetas', default: '#FDF0F5' },
  { key: 'badge-text', cssVar: '--color-badge-text', label: 'Badges — texto', category: 'tarjetas', default: '#EA7EA3' },
  { key: 'chip-bg', cssVar: '--color-chip-background', label: 'Chips — fondo', category: 'tarjetas', default: '#FDF0F5' },
  { key: 'chip-text', cssVar: '--color-chip-text', label: 'Chips — texto', category: 'tarjetas', default: '#EA7EA3' },

  // Modales y overlays
  { key: 'modal-bg', cssVar: '--color-modal-background', label: 'Modales — fondo', category: 'modales', default: '#FFFFFF' },
  { key: 'modal-border', cssVar: '--color-modal-border', label: 'Modales — borde', category: 'modales', default: '#FADCE9' },
  { key: 'modal-overlay', cssVar: '--color-modal-overlay', label: 'Fondo detrás del modal', category: 'modales', default: 'rgba(20,10,14,0.55)' },
  { key: 'tooltip-bg', cssVar: '--color-tooltip-background', label: 'Tooltips — fondo', category: 'modales', default: '#EA7EA3' },
  { key: 'tooltip-text', cssVar: '--color-tooltip-text', label: 'Tooltips — texto', category: 'modales', default: '#FFFFFF' },
  { key: 'empty-state-text', cssVar: '--color-empty-state-text', label: 'Estados vacíos — texto', category: 'modales', default: '#EA7EA3' },

  // Productos y carrito
  { key: 'price', cssVar: '--color-price', label: 'Precio', category: 'productos', default: '#EA7EA3' },
  { key: 'price-old', cssVar: '--color-price-old', label: 'Precio anterior (tachado)', category: 'productos', default: '#EA7EA3' },
  { key: 'rating-star', cssVar: '--color-rating-star', label: 'Estrellas de reseña', category: 'productos', default: '#EA7EA3' },
  { key: 'cart-badge-bg', cssVar: '--color-cart-badge-background', label: 'Badge del carrito — fondo', category: 'productos', default: '#EA7EA3' },
  { key: 'cart-badge-text', cssVar: '--color-cart-badge-text', label: 'Badge del carrito — texto', category: 'productos', default: '#FFFFFF' },

  // Avanzado
  { key: 'icon-primary', cssVar: '--color-icon-primary', label: 'Íconos principales', category: 'avanzado', default: '#EA7EA3' },
  { key: 'icon-secondary', cssVar: '--color-icon-secondary', label: 'Íconos secundarios', category: 'avanzado', default: '#EA7EA3' },
  { key: 'icon-disabled', cssVar: '--color-icon-disabled', label: 'Íconos deshabilitados', category: 'avanzado', default: '#EA7EA3' },
  ...
  { key: 'switch-on-bg', cssVar: '--color-switch-on-background', label: 'Switch — encendido', category: 'avanzado', default: '#EA7EA3' },
  { key: 'switch-off-bg', cssVar: '--color-switch-off-background', label: 'Switch — apagado', category: 'avanzado', default: '#FADCE9' },
  { key: 'switch-thumb', cssVar: '--color-switch-thumb', label: 'Switch — perilla', category: 'avanzado', default: '#FFFFFF' },
  { key: 'checkbox-checked', cssVar: '--color-checkbox-checked-background', label: 'Checkbox marcado', category: 'avanzado', default: '#EA7EA3' },
  { key: 'checkbox-border', cssVar: '--color-checkbox-border', label: 'Checkbox — borde', category: 'avanzado', default: '#FADCE9' },
  { key: 'radio-checked', cssVar: '--color-radio-checked-background', label: 'Radio marcado', category: 'avanzado', default: '#EA7EA3' },
  { key: 'radio-border', cssVar: '--color-radio-border', label: 'Radio — borde', category: 'avanzado', default: '#FADCE9' },
  { key: 'progress-track', cssVar: '--color-progress-track', label: 'Barra de progreso — riel', category: 'avanzado', default: '#FADCE9' },
  { key: 'progress-fill', cssVar: '--color-progress-fill', label: 'Barra de progreso — relleno', category: 'avanzado', default: '#EA7EA3' },
  { key: 'skeleton-base', cssVar: '--color-skeleton-base', label: 'Skeleton loader — base', category: 'avanzado', default: '#FADCE9' },
  { key: 'skeleton-shine', cssVar: '--color-skeleton-shine', label: 'Skeleton loader — brillo', category: 'avanzado', default: '#FDF0F5' },
  { key: 'selection-bg', cssVar: '--color-selection-background', label: 'Selección de texto — fondo', category: 'avanzado', default: '#EA7EA3' },
  { key: 'selection-text', cssVar: '--color-selection-text', label: 'Selección de texto — color', category: 'avanzado', default: '#FFFFFF' },
  { key: 'loading-spinner', cssVar: '--color-loading-spinner', label: 'Spinner de carga', category: 'avanzado', default: '#EA7EA3' },
];
