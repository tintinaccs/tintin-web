import { renderDesktopHeader } from './escritorio/encabezado-escritorio.js?v=tintin-20260916-final-production-stability-desktop-1';
import { renderTabletHeader, renderTabletMenu } from './tableta/encabezado-tableta.js?v=tintin-20260916-final-production-stability-tablet-1';
...
import { ensureNavigationAssets } from './compartido/recursos-navegacion.js?v=tintin-20260916-final-production-stability-assets-1';
import { loadProductsRuntime, loadSharedRuntime } from './compartido/carga-navegacion.js?v=tintin-20260918-global-session-restore-1';
...
async function loadFinalStability() {
  ...
  await import('../../quality/estabilidad-final-publica.js?v=tintin-20260918-global-session-restore-1');
