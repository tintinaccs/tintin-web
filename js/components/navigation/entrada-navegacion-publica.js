...
import { loadProductsRuntime, loadSharedRuntime } from './compartido/carga-navegacion.js?v=tintin-20260922-profile-timeout-fix-1-app-check-retry-cascade-1';
...
async function loadFinalStability() {
  ...
  await import('../../quality/estabilidad-final-publica.js?v=tintin-20260918-header-system-solid-surfaces-1-auth-persistence-20260919-1-app-check-retry-cascade-1');
