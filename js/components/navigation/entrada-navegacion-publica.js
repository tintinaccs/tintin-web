...
import { loadProductsRuntime, loadSharedRuntime } from './compartido/carga-navegacion.js?v=tintin-20260923-auth-preview-isolation-1-auth-popup-resolver-1';
...
async function loadFinalStability() {
  ...
  await import('../../quality/estabilidad-final-publica.js?v=tintin-20260918-header-system-solid-surfaces-1-auth-persistence-20260919-1-app-check-retry-cascade-1-auth-popup-resolver-1');
