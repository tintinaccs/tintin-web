import { renderDesktopHeader } from './escritorio/encabezado-escritorio.js?v=tintin-20260921-document-navigation-no-view-transition-2';
import { renderTabletHeader, renderTabletMenu } from './tableta/encabezado-tableta.js?v=tintin-20260921-document-navigation-no-view-transition-2';
...
import { loadProductsRuntime, loadSharedRuntime } from './compartido/carga-navegacion.js?v=tintin-20260921-document-navigation-no-view-transition-2';
