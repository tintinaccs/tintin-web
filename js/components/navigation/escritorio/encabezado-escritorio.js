...
export function renderDesktopHeader(initialLogo = logoUrl()) {
  return `
    <header class="tt-header tt-header-desktop" id="tt-header-desktop-tablet" data-header-device="desktop">
      <div class="tt-header-inner">
        <a href="/" class="tt-logo-link" aria-label="Tintin, ir al inicio">
          <img loading="eager" decoding="async" fetchpriority="high" src="${initialLogo}" alt="TINTIN Accesorios &amp; Relojes" class="tt-logo-img">
        </a>
