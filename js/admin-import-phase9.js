...
if (!window.TintinAdminImportPhase9Booted) {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      .phase9-card{border:1.5px solid #e6b6c7}.phase9-head{align-items:flex-start;gap:12px}.phase9-subtitle{font-size:12px;color:var(--adm-muted);margin:5px 0 0}.phase9-project{font:700 11px monospace;background:#f8edf2;color:#a64068;border-radius:999px;padding:6px 10px}
