...
import { createOrderViaServer } from '../create-order-public-client.js?v=tintin-20260914-session-unified-1';
...
if (!window.TintinSecureCheckoutOrderBooted) {
  ...
  if (!window.TintinCheckoutEmailBridgeLoading) {
    ...
    import('../pages/checkout/checkout-puente-correo.js?v=tintin-20260814-social-notifications-3').catch(error => {
