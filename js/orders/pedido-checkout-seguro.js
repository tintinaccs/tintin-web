...
import { AUTH_STATES, getSessionUser, waitForSession, subscribeAuthState } from '../core/auth/coordinador-sesion.js?v=tintin-20260924-auth-state-authority-1-auth-popup-resolver-1';
import {
  doc,
  getDoc,
  runTransaction,
...
import { createOrderViaServer } from '../create-order-public-client.js?v=tintin-20260918-global-session-restore-1-auth-persistence-20260919-1-auth-popup-resolver-1';
...
if (!window.TintinSecureCheckoutOrderBooted) {
  ...
  if (!window.TintinCheckoutEmailBridgeLoading) {
    ...
    import('../pages/checkout/checkout-puente-correo.js?v=tintin-20260814-social-notifications-3-auth-persistence-20260919-1-auth-popup-resolver-1').catch(error => {
