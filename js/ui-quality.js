...
var TT_CACHE_VERSION='tintin-20260708-1';
...
function singleLogoLoader(){var logo='assets-tintin/images/general/logo.png?v='+TT_CACHE_VERSION;document.querySelectorAll('#tt-loader-line,#tt-loader-text,#tt-loader-dots,.tt-splash-line,#tt-intro-fallback').forEach(function(el){el.remove()});document.querySelectorAll('#tt-loader-logo,#tt-intro-logo').forEach(function(img){if(!img||img.dataset.ttSingleLogo)return;img.dataset.ttSingleLogo='1';img.alt='';img.removeAttribute('aria-label');if(img.src.indexOf('logo.png')===-1||img.src.indexOf('v='+TT_CACHE_VERSION)===-1)img.src=logo;img.addEventListener('error',function(){img.style.display='none'},{once:true})})}
