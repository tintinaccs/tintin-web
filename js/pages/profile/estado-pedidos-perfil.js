...
async function currentUserKey() {
  try {
    const { AUTH_STATES, waitForSession } = await import('../../core/auth/coordinador-sesion.js?v=tintin-20260924-auth-state-authority-1-auth-session-never-unknown-3-auth-popup-resolver-1');
