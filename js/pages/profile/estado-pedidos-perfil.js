...
async function currentUserKey() {
  try {
    const { AUTH_STATES, waitForSession } = await import('../../core/auth/coordinador-sesion.js?v=tintin-20260921-auth-session-never-unknown-3-app-check-retry-cascade-1');
