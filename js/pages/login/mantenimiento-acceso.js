...
if (LOGIN_RE.test(location.pathname || '') && !window.TintinLoginMaintenanceBooted) {
  ...
  async function repairCanonicalProfileIfNeeded() {
    const [{ db }, profileModule, firestoreApi, { subscribeAuthState }] = await Promise.all([
      import('../../core/firebase/firebase.js?v=tintin-20260924-auth-persistence-init-1'),
      import('../../core/store/perfil-usuario.js?v=tintin-20260923-user-reentry-2'),
      import('https://www.gstatic.com/firebasejs/10.14.1/firebase-firestore.js'),
      import('../../core/auth/coordinador-sesion.js?v=tintin-20260924-auth-state-authority-1'),
    ]);
