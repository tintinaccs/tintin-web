...
import { resolveCollectionImage } from '../../components/images/resolucion-imagenes.js?v=tintin-20260716-cloudinary-fix-3-auth-persistence-20260919-1-auth-popup-resolver-1-launch-20260926-1';
import {
  readCached,
  readStaleCached,
  recordFirestoreRead,
...
if (/(^|\/)admin(?:\.html)?$/i.test(location.pathname)) {
  Promise.allSettled([
    ...
    import('../../admin/settings/metodos-pago-admin.js?v=tintin-20260918-global-session-restore-1-auth-persistence-20260919-1-auth-popup-resolver-1-launch-20260926-1')
  ]);
}
