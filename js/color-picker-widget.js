...
function injectStyles() {
  ...
  style.textContent = `
    .tcp-pop{position:fixed;z-index:9000;width:264px;background:var(--admin-color-background-surface,#fff);border:1px solid var(--admin-color-border,#F1E4E7);border-radius:14px;box-shadow:0 12px 40px rgba(0,0,0,.18);padding:14px;font-family:inherit}
    ...
    .tcp-input{flex:1;min-width:0;padding:7px 8px;border:1px solid var(--admin-color-field-border,#F1E4E7);border-radius:8px;font-size:12.5px;font-family:inherit;color:var(--admin-color-text-primary,#2B2B2B);background:var(--admin-color-field-background,#fff)}
