...
ready(function(){
 ...
 cleanTabbarAvatar();
 if('MutationObserver'in window){new MutationObserver(cleanTabbarAvatar).observe(document.documentElement,{childList:true,subtree:true});}
});
})();