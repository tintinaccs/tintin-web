/**
 * TINTIN — cliente de creación segura de pedidos V2.
 *
...
export async function createOrderViaServer(draft) {
  ...
  try {
    ...
    console.error('[create-order-client-v2] No se pudo conectar con el endpoint de pedidos.', error);
  ...
  try {
    ...
    console.error('[create-order-client-v2] El endpoint devolvió una respuesta no válida. HTTP', response.status);
