...
function ensureStudioUi() {
  ...
  if (!document.getElementById('visual-studio-v2-css')) {
    const link=document.createElement('link'); link.id='visual-studio-v2-css'; link.rel='stylesheet'; link.href='css/admin/visual-studio-v2.css?v=tintin-20260812-preview-dispositivos-reales-1'; document.head.appendChild(link);
  }
