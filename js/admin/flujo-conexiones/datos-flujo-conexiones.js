...
const RAW_NODES = [
  ...
  { id: 'pedidos', label: 'Pedidos', category: 'dominio', state: ESTADOS.PROD,
    evidence: [{ file: 'functions/api/admin-order-mutation.js', note: 'Dominio canónico de creación, edición y actualización de pago' },
               { file: 'js/admin/admin-app.js', line: 2547, note: 'updatePayStatus() delega en /api/admin-order-mutation' },
               { file: 'js/admin/orders/pedidos-superadmin-crud.js', line: 375, note: 'Edición y creación delegadas en /api/admin-order-mutation' }],
    notes: 'Las mutaciones comerciales del panel usan la misma autoridad server-side que sincroniza inventario y Sheets.' },
...
const RAW_EDGES = [
  ...
  { from: 'super-panel', to: 'pedidos', state: ESTADOS.PROD },
