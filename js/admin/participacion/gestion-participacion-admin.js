...
function reviewCard(review) {
  ...
  return `<article class="adm-engagement-card" data-review-id="${escapeHtml(review.reviewId)}">
    ...
    ${review.editCount ? `<div class="adm-engagement-history">Editada por la clienta. Versi&oacute;n anterior: ${escapeHtml(review.original?.comment || history.find(item => item.action === 'customer_edit')?.comment || 'registrada en historial')}.</div>` : ''}
