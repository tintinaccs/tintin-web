...
import { SUPER_ADMIN, ROLE_LABELS } from '../../core/auth/roles.js?v=tintin-20260916-final-polish-2-auth-persistence-20260919-1-app-check-retry-cascade-1-auth-popup-resolver-1';
...
if (!window.TintinAdminUserFichaBooted) {
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', () => subscribeAuthState(bootForSuperAdmin), { once: true });
  } else {
    subscribeAuthState(bootForSuperAdmin);
  }
}
