...
if (!window.TintinAdminContentPhase6Booted) {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .content-phase6-toast{position:fixed;right:20px;bottom:24px;z-index:5000;background:#1a1a1a;color:#fff;padding:12px 17px;border-radius:10px;font:600 12px Poppins,sans-serif;opacity:0;transform:translateY(8px);pointer-events:none;transition:.2s}.content-phase6-toast.show{opacity:1;transform:none}.content-phase6-toast.is-error{background:#b3261e}
