...
async function enhanceProfile() {
  ...
  await import('../pages/profile/estado-pedidos-perfil.js?v=tintin-20260918-global-session-restore-1-auth-persistence-20260919-1-app-check-retry-cascade-1-auth-popup-resolver-1');
