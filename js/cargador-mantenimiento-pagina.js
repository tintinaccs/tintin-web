import './pages/catalog/politica-visibilidad-catalogo.js?v=tintin-20260918-global-session-restore-1-auth-persistence-20260919-1-app-check-retry-cascade-1-auth-popup-resolver-1';
...
export function loadPageMaintenance() {
  ...
  if (/\/checkout(?:\.html)?$/.test(path)) {
    const version = 'tintin-20260914-checkout-no-deadlock-1';
