...
var CSS=['html.tt-scroll-locked,html.tt-scroll-locked body{overflow:hidden!important;overscroll-behavior:none!important;touch-action:none!important}','body.tt-scroll-locked{position:fixed!important;left:0!important;right:0!important;width:100%!important;overflow:hidden!important;overscroll-behavior:none!important}','#tt-loader{position:fixed;inset:0;z-index:2147483000;display:flex;align-items:center;justify-content:center;background:#FFF6FA;transition:opacity .38s ease,visibility .38s ease;overflow:hidden;overscroll-behavior:none;touch-action:none}','#tt-loader.tt-out{opacity:0;visibility:hidden;pointer-events:none}','#tt-loader-spin-wrap{position:relative;display:flex;align-items:center;justify-content:center;perspective:800px}','#tt-loader-logo{position:relative;z-index:1;width:clamp(180px,15vw,220px);max-width:72vw;height:auto;object-fit:contain;display:block;opacity:0;transform:translateY(8px) scale(.96);filter:drop-shadow(0 8px 22px rgba(212,106,138,.18));user-select:none;pointer-events:none;backface-visibility:visible}','#tt-loader-spin-wrap.tt-ready #tt-loader-logo{animation:tt-logo-only-in .48s cubic-bezier(.22,.61,.36,1) both,tt-logo-axis-spin 2.6s ease-in-out .48s infinite}','#tt-loader-ring{position:absolute;top:50%;left:50%;width:calc(100% + 34px);height:calc(100% + 34px);border-radius:50%;border:3px solid rgba(212,106,138,.15);border-top-color:#D46A8A;transform:translate(-50%,-50%) rotate(0deg);opacity:0;pointer-events:none}','#tt-loader-spin-wrap.tt-ready #tt-loader-ring{animation:tt-ring-fade-in .3s ease .2s forwards,tt-ring-spin 1s linear infinite .2s}','@keyframes tt-logo-only-in{from{opacity:0;transform:translateY(8px) scale(.96) rotateY(0deg)}to{opacity:1;transform:translateY(0) scale(1) rotateY(0deg)}}','@keyframes tt-logo-axis-spin{0%,100%{transform:translateY(0) scale(1) rotateY(0deg)}50%{transform:translateY(0) scale(1) rotateY(360deg)}}','@keyframes tt-ring-fade-in{to{opacity:1}}','@keyframes tt-ring-spin{from{transform:translate(-50%,-50%) rotate(0deg)}to{transform:translate(-50%,-50%) rotate(360deg)}}','@media (max-width:600px){#tt-loader-logo{width:clamp(110px,30vw,150px)}}','@media (min-width:601px) and (max-width:1120px){#tt-loader-logo{width:clamp(150px,20vw,190px)}}','@media (prefers-reduced-motion:reduce){#tt-loader{transition:opacity .01s linear}#tt-loader-spin-wrap.tt-ready #tt-loader-logo{animation:none;opacity:1;transform:none}#tt-loader-ring{display:none}}'].join('');
