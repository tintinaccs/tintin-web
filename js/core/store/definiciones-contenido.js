    ...
    sections: {
      ...
      editorial_relojes: {
        ...
        fields: [
          ...
          field('body', 'Descripción', '.tt-watch-desc', 'Relojes de acero inoxidable, elegantes y femeninos, para acompañarte del día a la noche.', { type: 'multiline', rows: 5, maxLength: 1200 }),
