import { auth } from '../firebase/firebase.js?v=tintin-20260924-auth-persistence-init-1-app-check-retry-1';
import { subscribeAuthState } from './coordinador-sesion.js?v=tintin-20260924-auth-state-authority-1-auth-session-never-unknown-3';
