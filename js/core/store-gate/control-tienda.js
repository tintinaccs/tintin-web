 ...
 */
import { auth, db, appCheckReady } from '../firebase/firebase.js?v=tintin-20260924-app-check-retry-1';
import { AUTH_STATES, subscribeSession } from '../auth/coordinador-sesion.js?v=tintin-20260923-auth-cache-coherence-1';
import {
  doc,
  onSnapshot
