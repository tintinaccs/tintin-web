 ...
 */
import { auth, db, appCheckReady } from '../firebase/firebase.js?v=tintin-20260924-auth-persistence-init-1-app-check-retry-1';
import { AUTH_STATES, subscribeSession } from '../auth/coordinador-sesion.js?v=tintin-20260924-auth-state-authority-1-auth-session-never-unknown-3';
import {
  doc,
  onSnapshot
