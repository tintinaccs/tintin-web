 ...
 */
import { auth, db, appCheckReady } from '../firebase/firebase.js?v=tintin-20260903-app-check-singleton-1';
import {
  onAuthStateChanged
...
} from './nucleo-control-tienda.js?v=tintin-20260830-store-gate-api-1';
