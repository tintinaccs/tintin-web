...
// =============================================================
import { auth, db, authPersistenceReady } from "../core/firebase/firebase.js?v=tintin-20260904-auth-runtime-cache-reset-1";
import {
...
export function otpErrorMessage(code) {
  const msgs = {
    ...
    'google_account_exists': 'Esta cuenta fue registrada con Google. Tocá «Continuar con Google» para ingresar; el código de email no está habilitado para esta cuenta.',
