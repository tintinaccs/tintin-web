...
const CONTACT_MAINTENANCE_RUNTIME = '/js/pages/institutional/mantenimiento-contacto.js?v=tintin-20260913-xss-hardening-1-auth-persistence-20260919-1-app-check-retry-cascade-1-auth-popup-resolver-1';
const LEGAL_MAINTENANCE_RUNTIME = '/js/pages/institutional/mantenimiento-legal.js?v=tintin-20260913-xss-hardening-1-auth-persistence-20260919-1-app-check-retry-cascade-1-auth-popup-resolver-1';
const MASTER_DIAGNOSTICS_RUNTIME = '/js/admin/diagnostics/diagnostico-maestro-admin.js?v=tintin-20260918-global-session-restore-1-auth-persistence-20260919-1-app-check-retry-cascade-1-auth-popup-resolver-1';
...
export function lightenHtml(html) {
  return String(html || '')
    ...
    .replace(
      /(<script\s+src=["'])js\/cargador-pagina\.js(\?[^"']*)(["'][^>]*><\/script>)/i,
      '$1/js/cargador-pagina.js$2&tt-lightweight=1$3'
    )
