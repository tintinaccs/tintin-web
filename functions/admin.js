...
const CODE_STUDIO_RUNTIME = '/js/admin/estudio-codigo/estudio-codigo-admin.js?v=tintin-20260821-code-problems-3';
const CODE_STUDIO_STYLES = '/css/admin/estudio-codigo.css?v=tintin-20260821-code-problems-1';
const CODE_STUDIO_RESTORE_RUNTIME = '/js/admin/estudio-codigo/restaurar-estudio-codigo-admin.js?v=tintin-20260821-code-editor-fit-6';
