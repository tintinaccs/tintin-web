...
ok(has(publicEntry, "estabilidad-final-publica.js?v=tintin-20260829-final-stability-3"), 'El shell público no conserva la estabilización final para las demás superficies.');
...
ok(has(stability, "estado-pedidos-perfil.js?v=tintin-20260829-final-stability-3"), 'Perfil no carga el estado canónico de pedidos no vistos.');
