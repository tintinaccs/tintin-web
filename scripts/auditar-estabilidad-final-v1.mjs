...
ok(has(publicEntry, "estabilidad-final-publica.js?v=tintin-20260918-header-system-solid-surfaces-1-auth-persistence-20260919-1"), 'El shell público no conserva la estabilización final para las demás superficies.');
