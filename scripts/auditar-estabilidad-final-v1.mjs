...
ok(has(publicEntry, "estabilidad-final-publica.js?v=tintin-20260923-auth-cache-coherence-1"), 'El shell público no conserva la estabilización final para las demás superficies.');
...
ok(has(stability, "estado-pedidos-perfil.js?v=tintin-20260923-auth-cache-coherence-1"), 'Perfil no carga el estado canónico de pedidos no vistos.');
