...
ok(has(publicEntry, "estabilidad-final-publica.js?v=tintin-20260918-global-session-restore-1"), 'El shell público no conserva la estabilización final para las demás superficies.');
