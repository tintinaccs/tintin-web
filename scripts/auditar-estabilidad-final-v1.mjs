...
ok(has(publicEntry, "estabilidad-final-publica.js?v=tintin-20260918-header-system-solid-surfaces-1"), 'El shell público no conserva la estabilización final para las demás superficies.');
...
ok(has(stability, "estado-pedidos-perfil.js?v=tintin-20260918-global-session-restore-1"), 'Perfil no carga el estado canónico de pedidos no vistos.');
