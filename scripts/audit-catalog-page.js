...
requireText(loader, /catalogo[\s\S]*load\('catalog-maintenance\.js'\)/, 'El runtime del Catálogo no se carga desde el cargador por página.');
...
console.log('AUDITORÍA CATÁLOGO: OK · 7 viewports · filtros, tokens, recuperación y carga específica verificados.');
