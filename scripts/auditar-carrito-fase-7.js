...
check(
  ...
  navigationRuntime.includes("const CART_RUNTIME_URL = '../../../components/cart/sincronizacion-carrito.js?v=tintin-20260918-global-session-restore-1-auth-persistence-20260919-1-app-check-retry-cascade-1-auth-popup-resolver-1'") &&
...
check(
  ...
  pkg.includes('"audit:cart": "node scripts/auditar-carrito-fase-7.js"'),
