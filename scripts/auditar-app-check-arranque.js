...
const checks = [
  ...
  [
    ...
    !allRuntime.includes('firebase.js?v=tintin-20260716-cloudinary-fix-1') &&
      ...
      allRuntime.includes('firebase.js?v=tintin-20260919-auth-persistence-authoritative-restore-1')
  ],
  [
    'Todas las páginas fuerzan el loader corregido',
    htmlFiles.every(file =>
      read(file).includes('cargador-pagina.js?v=tintin-20260916-premium-performance-loader-1')
    )
  ],
  [
