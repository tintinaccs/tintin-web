...
check('Todas las páginas usan la versión de caché de Fase 10', htmlFiles.every(file => !read(file).includes('js/page-loader.js') || read(file).includes('js/page-loader.js?v=tintin-20260801-unified-surfaces-15')), 'No debe quedar una página con el loader anterior.');
