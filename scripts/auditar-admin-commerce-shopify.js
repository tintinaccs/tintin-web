...
expect(html.includes('js/admin/shopify-commerce-admin.js?v=tintin-20260820-microcopy-ios-1'), 'admin.html carga la nueva experiencia de comercio versionada.');
