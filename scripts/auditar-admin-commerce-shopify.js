...
expect(html.includes('js/admin/shopify-commerce-admin.js?v=tintin-20260908-appcheck-ready-1'), 'admin.html carga la nueva experiencia de comercio versionada.');
