...
check('Todas las páginas usan la versión vigente del loader', htmlFiles.every(file => !read(file).includes('js/cargador-pagina.js') || read(file).includes('js/cargador-pagina.js?v=tintin-20260827-navigation-top-1')), 'No debe quedar una página con el loader anterior.');
