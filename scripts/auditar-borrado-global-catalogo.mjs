...
expect(admin.includes('js/admin/products/borrado-global-catalogo-admin.js?v=tintin-20260918-global-session-restore-1-auth-persistence-20260919-1'), 'admin.html no carga el módulo versionado de borrado global.');
