...
if (!pageFunction.includes('mantenimiento-contacto.js?v=tintin-20260913-xss-hardening-1-auth-persistence-20260919-1-app-check-retry-cascade-1')) missing.push('functions/[page].js: versioned contact runtime injection');
