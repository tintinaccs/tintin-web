...
if (!pageFunction.includes('mantenimiento-contacto.js?v=tintin-20260818-contact-clock-svg-3')) missing.push('functions/[page].js: versioned contact runtime injection');
