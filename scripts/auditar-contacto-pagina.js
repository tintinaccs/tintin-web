...
if (!pageFunction.includes('mantenimiento-contacto.js?v=tintin-20260820-microcopy-ios-1')) missing.push('functions/[page].js: versioned contact runtime injection');
