...
if (!pageFunction.includes('mantenimiento-contacto.js?v=tintin-20260913-xss-hardening-1')) missing.push('functions/[page].js: versioned contact runtime injection');
