...
check(
  ...
  /tintin-20260910-global-shell-7/.test(loader),
...
check(
  ...
  return !html.includes('js/cargador-pagina.js') || html.includes('js/cargador-pagina.js?v=tintin-20260910-global-shell-7');
  }),
