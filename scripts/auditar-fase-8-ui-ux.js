...
check(
  ...
  /tintin-20260911-hero-no-entry-animation-1/.test(loader),
...
check(
  ...
  return !html.includes('js/cargador-pagina.js') || html.includes('js/cargador-pagina.js?v=tintin-20260911-hero-no-entry-animation-1');
  }),
