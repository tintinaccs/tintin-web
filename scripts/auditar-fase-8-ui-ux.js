...
check(
  ...
  /tintin-20260923-auth-preview-isolation-1/.test(loader),
...
check(
  ...
  return !html.includes('js/cargador-pagina.js') || html.includes('js/cargador-pagina.js?v=tintin-20260923-auth-preview-isolation-1');
  }),
