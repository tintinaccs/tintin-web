...
check(
  ...
  /tintin-20260909-global-shell-3/.test(loader),
...
check(
  ...
  return !html.includes('js/cargador-pagina.js') || html.includes('js/cargador-pagina.js?v=tintin-20260909-global-shell-3');
  }),
