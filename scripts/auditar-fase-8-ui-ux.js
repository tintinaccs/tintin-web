...
check(
  ...
  /tintin-20260925-cache-converge-1/.test(loader),
...
check(
  ...
  return !html.includes('js/cargador-pagina.js') || html.includes('js/cargador-pagina.js?v=tintin-20260926-loader-contrast-b-1-launch-20260926-1');
  }),
