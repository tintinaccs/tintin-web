...
check(
  ...
  /tintin-20260908-public-activity-auth-1/.test(loader),
...
check(
  ...
  return !html.includes('js/cargador-pagina.js') || html.includes('js/cargador-pagina.js?v=tintin-20260908-public-activity-auth-1');
  }),
