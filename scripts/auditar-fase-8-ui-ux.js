...
check(
  ...
  /tintin-20260827-navigation-top-1/.test(loader),
...
check(
  ...
  return !html.includes('js/cargador-pagina.js') || html.includes('js/cargador-pagina.js?v=tintin-20260827-navigation-top-1');
  }),
