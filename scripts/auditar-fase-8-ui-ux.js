...
check(
  ...
  /tintin-20260811-cls-reveal-fix-1/.test(loader),
...
check(
  ...
  return !html.includes('js/cargador-pagina.js') || html.includes('js/cargador-pagina.js?v=tintin-20260811-cls-reveal-fix-1');
  }),
