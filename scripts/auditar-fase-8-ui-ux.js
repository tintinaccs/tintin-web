...
check(
  ...
  /tintin-20260816-loader-min-show-1/.test(loader),
...
check(
  ...
  return !html.includes('js/cargador-pagina.js') || html.includes('js/cargador-pagina.js?v=tintin-20260816-loader-min-show-1');
  }),
