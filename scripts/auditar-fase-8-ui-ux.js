...
check(
  ...
  /tintin-20260916-premium-performance-loader-1/.test(loader),
...
check(
  ...
  return !html.includes('js/cargador-pagina.js') || html.includes('js/cargador-pagina.js?v=tintin-20260916-premium-performance-loader-1');
  }),
