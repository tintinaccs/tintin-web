...
check('Admin carga Maestro directamente con versión explícita', adminHtml.includes('js/admin/maestro/panel-maestro.js?v=tintin-20260918-global-session-restore-2'));
