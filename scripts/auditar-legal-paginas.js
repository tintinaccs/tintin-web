...
if (!pageFunction.includes('mantenimiento-legal.js?v=tintin-20260913-xss-hardening-1-auth-persistence-20260919-1-app-check-retry-cascade-1')) errors.push('Pages Function no inyecta runtime legal versionado');
