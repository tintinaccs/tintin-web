...
check(
  ...
  checkout.includes('import { sendOrderNotification } from "./js/email-notify.js"') &&
    notify.includes("import('./checkout-email-bridge.js?v=tintin-20260716-color-scheme-1')"),
...
check(
  ...
  adminStore.includes("import('./admin-email-gate-sync.js?v=tintin-20260716-color-scheme-1')"),
