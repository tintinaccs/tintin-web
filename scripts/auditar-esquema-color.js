...
const globalCss = read('css/core/tokens-color.css');
...
].filter(rel => !['css/core/tokens-color.css', 'css/admin/admin-color-tokens.css', 'js/components/color/esquema-color-catalogo.js'].includes(rel.replace(/\\/g, '/')));
...
const missingPublicAssets = publicPages.filter(file => {
  ...
  return !html.includes('css/core/tokens-color.css') ||
    !html.includes('css/core/tema-unificado-tintin.css') ||
