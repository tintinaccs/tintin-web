...
const required = [
  'scripts/audit-phase5-performance.js',
  'scripts/audit-phase6-security.js',
  'scripts/audit-phase7-catalog.js',
  'scripts/audit-phase8-ui-ux.js',
  'tests/import/phase9-import-normalization.test.mjs',
  'scripts/audit-phase10-accessibility.js',
  'scripts/audit-phase11-seo.js',
  'scripts/audit-phase12-release.mjs',
  'scripts/production-smoke-phase12.mjs',
  'docs/PHASE12_RELEASE_REPORT.md',
  '.github/workflows/phase12-final-release.yml'
];
...
const workflow = read('.github/workflows/phase12-final-release.yml');
for (const token of [
  'npm run audit:final',
  ...
  'node scripts/production-smoke-phase12.mjs'
]) {
