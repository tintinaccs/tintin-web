...
const COLOR_FIRST_PAINT_VERSION = 'tintin-20260918-global-session-restore-1-auth-persistence-20260919-1-app-check-retry-cascade-1-auth-popup-resolver-1';
const LOADER_VERSION = 'tintin-20260923-auth-preview-isolation-1';
const STORE_GATE_VERSION = 'tintin-20260918-global-session-restore-1-auth-persistence-20260919-1-app-check-retry-cascade-1-auth-popup-resolver-1';
const PANEL_COMPAT_VERSION = 'tintin-20260811-cls-desktop-stable-2';
const PUBLIC_SHELL_VERSION = 'tintin-20260923-auth-preview-isolation-1-app-check-retry-cascade-1-auth-popup-resolver-1';
const NAV_ENTRY_VERSION = 'tintin-20260923-auth-preview-isolation-1-app-check-retry-cascade-1-auth-popup-resolver-1';
...
const SESSION_PROTECTION_VERSION = 'tintin-20260918-global-session-restore-1-auth-persistence-20260919-1-app-check-retry-cascade-1-auth-popup-resolver-1';
const PROFILE_GATE_VERSION = 'tintin-20260918-auth-incident-diagnostics-1-auth-persistence-20260919-1-app-check-retry-cascade-1-auth-popup-resolver-1';
