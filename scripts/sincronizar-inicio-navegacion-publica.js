...
const TIENDA_VERSION = 'tintin-20260925-cache-converge-1-launch-20260926-1';
...
const LOADER_VERSION = 'tintin-20260926-loader-contrast-b-1-launch-20260926-1';
...
const PUBLIC_SHELL_VERSION = 'tintin-20260925-cache-converge-1-launch-20260926-1';
const NAV_ENTRY_VERSION = 'tintin-20260925-cache-converge-1-launch-20260926-1';
const NAV_BARRIER_VERSION = 'tintin-20260915-session-shell-2';
const VISUAL_BUILDER_VERSION = 'tintin-20260925-cache-converge-1-launch-20260926-1';
const SESSION_PROTECTION_VERSION = 'tintin-20260918-global-session-restore-1-auth-persistence-20260919-1-auth-popup-resolver-1-launch-20260926-1';
const PROFILE_GATE_VERSION = 'tintin-20260918-auth-incident-diagnostics-1-auth-persistence-20260919-1-auth-popup-resolver-1-launch-20260926-1';
