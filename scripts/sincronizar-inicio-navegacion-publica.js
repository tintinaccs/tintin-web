...
const PUBLIC_SHELL_VERSION = 'tintin-20260816-header-logo-only-1';
const NAV_ENTRY_VERSION = 'tintin-20260816-header-logo-only-1';
const NAV_BARRIER_VERSION = 'tintin-20260816-header-logo-only-1';
