...
const COLOR_FIRST_PAINT_VERSION = 'tintin-20260918-global-session-restore-1';
const LOADER_VERSION = 'tintin-20260916-premium-performance-loader-1';
const STORE_GATE_VERSION = 'tintin-20260918-global-session-restore-1';
const PANEL_COMPAT_VERSION = 'tintin-20260811-cls-desktop-stable-2';
const PUBLIC_SHELL_VERSION = 'tintin-20260918-global-session-restore-1';
const NAV_ENTRY_VERSION = 'tintin-20260918-header-system-solid-surfaces-1';
...
const SESSION_PROTECTION_VERSION = 'tintin-20260918-global-session-restore-1';
const PROFILE_GATE_VERSION = 'tintin-20260918-auth-incident-diagnostics-1';
