...
check(
  ...
  /tintin-20260801-unified-surfaces-15/.test(loader),
...
check(
  ...
  return !html.includes('js/page-loader.js') || html.includes('js/page-loader.js?v=tintin-20260801-unified-surfaces-15');
  }),
