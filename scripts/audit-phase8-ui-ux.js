...
check(
  ...
  /tt-phase8-ui-ux-css/.test(loader) &&
    ...
    /tintin-20260731-loader-context-labels-1/.test(loader),
...
check(
  ...
  htmlFiles.every(file => {
    ...
    return !html.includes('js/page-loader.js') || html.includes('js/page-loader.js?v=tintin-20260731-loader-context-labels-1');
  }),
