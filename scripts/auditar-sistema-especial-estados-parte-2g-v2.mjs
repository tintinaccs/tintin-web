...
async function mountBlocked(page) {
  ...
  }, `${baseUrl}/js/components/modals/modal-bloqueo.js?audit=${Date.now()}-${Math.random()}`);
...
async function mountCatalogState(page, state) {
  await page.addStyleTag({ url: `${baseUrl}/css/pages/catalog/catalog-maintenance.css?v=tintin-20260809-loader-motion-fix-1` });
