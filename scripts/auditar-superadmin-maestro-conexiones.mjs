...
check('maestro-entry', 'Maestro tiene entrada versionada directa desde admin.html', has(files.admin, 'js/admin/maestro/panel-maestro.js?v=tintin-20260918-global-session-restore-2-auth-persistence-20260919-1'));
...
check('maestro-version-lock', 'Panel y entrada HTML usan la misma versión propia de Maestro',
  ...
  has(files.admin, 'js/admin/maestro/panel-maestro.js?v=tintin-20260918-global-session-restore-2-auth-persistence-20260919-1'));
