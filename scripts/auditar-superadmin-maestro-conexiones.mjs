...
check('maestro-entry', 'Maestro tiene entrada versionada directa desde admin.html', has(files.admin, 'js/admin/maestro/panel-maestro.js?v=tintin-20260923-auth-cache-coherence-1'));
...
check('maestro-version-lock', 'Panel y entrada HTML usan la misma versión propia de Maestro',
  ...
  has(files.admin, 'js/admin/maestro/panel-maestro.js?v=tintin-20260923-auth-cache-coherence-1'));
