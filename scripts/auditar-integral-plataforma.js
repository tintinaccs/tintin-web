...
check(
  ...
  !files.home.includes("import { onCollectionsUpdate } from './js/pages/collections/estado-colecciones.js?v=tintin-20260820-microcopy-ios-1'") &&
    !files.home.includes("import { onImagesUpdate } from './js/components/images/imagenes.js?v=tintin-20260820-microcopy-ios-1'"),
